...
- when: 20260704_050744
- machine: **win-x64**
- build: lmforge 0.1.5 (60c4857 2026-07-03) | checkout: 60c4857
...
|---|---|---|---|
| TC-E01 | PASS | Sequential load embed+chat | embed=3889ms chat=6519ms (no-burst: co-residency not required) |
...
| TC-E08 | PASS | VLM text-only | 8035ms |
| TC-E09 | PASS | VLM image_url (remote) | 4313ms |
| TC-E10 | PASS | VLM image_url (base64) | 4091ms |
| TC-E11 | PASS | Rerank endpoint | 3908ms |
| TC-E12 | SKIP | MTP speculative | mode=off |
| TC-E14 | PASS | Thinking off non-blank | 5 chars |
| TC-E13 | PASS | Thinking on reasoning+answer | r=5868 a=227 |
| TC-E15 | PASS | Thinking budget answer | 557 chars |
